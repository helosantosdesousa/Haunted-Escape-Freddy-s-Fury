    ...
    public static void main(String[] args) {
        ...
        while (menu == 1) {
            ...
            if (charComando == 'r') {
                ...
                System.out.println("5. A cada hora, uma porta de saída é aberta, você deve acertar a porta antes das 6 A.M.");
                System.out.println("6. Assim como você, o Freddy muda de sala a cada jogada.");
                System.out.println("7. Se você achar a porta, mas mesmo assim o Freddy estiver na sala, você perde.");
                System.out.println("8. Você tem 6 horas para sair da pizzaria");
                System.out.println("9. Uma hora equivale a 3 jogadas. Ou seja, você tem 18 jogadas");
                System.out.println(" ");
            ...
            if (charComando == 'c' || charComando == 'C') {
                ...
                while (jogadas < 18 && menu==1) {
                    ...
                    if (jogadas==0 || jogadas==3 || jogadas==6 || jogadas==9 || jogadas==12 || jogadas==18){
                   ...
                   //System.out.println("Porta aleatória: " + minimo + " e " + maximo + ": " + portaAleatoria);
                    ...
                    if (movimento == portaAleatoria && numeroAleatorio!=portaAleatoria) {
                        jogadas--;
